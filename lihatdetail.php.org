        ...
        <table class="table table-bordered" >
          ...
          <tr>
           <form method="post" action="?action=add&id=<?php echo $values['id']; ?>">
            ...
            <td>
              <input class="form-control qty" type="number" name="quantity" value="<?php echo $values["item_quantity"]; ?>" min="1">
            ...
            <input type="hidden" name="hidden_price" value="<?php echo $values["item_price"] ; ?>" />
             <a  class="btn btn-danger"  onclick="return confirm('<?php if(isset($_SESSION['uid'])){echo $_SESSION['u_first']." ".$_SESSION['u_last']." Yakin ". $values['item_name']. " Anda ingin di Ubah?";}else{echo"";}?>');" href="?action=ubah&id=<?php echo $values["id"]; ?>"><span ">Ubah</span></a></td>
