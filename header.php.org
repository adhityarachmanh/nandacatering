    ...
    <section class="ctn-wrp main-wrp">
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 nopadding logo current_page_item ">
                <a href="index.php" title="Zaxbys Home">
                </a>
            </div>
...
?>
                            ...
                            <div class="bottom-nav-links mobile-bottom-nav">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="/about/" title="Order Now">About</a>
                                    </li>
                                    <li><a href="http://www.zaxbysfranchising.com/" title="Franchising" target="_blank">Franchising</a></li>
                                    <li><a href="/join-the-team/" title="Join the Team" target="_blank">Join the Team</a></li>
                                    <li><a href="/gift-cards/" title="Gift Cards" target="_blank">Gift Cards</a></li>
                            ...
                            <div id="subnavId" class="sub-nav">
                                ...
                                <div class="user-info user-info-wrapper">
                                    <div class="user-info  user-left">
                                        ...
                                        <a href="inc/logout.inc.php?halaman=<?php $a=$_SERVER['REQUEST_URI']; $b=explode("/",$a); echo $b['3']; ?>" type="submit" class="login <?php if ($_SESSION['uid']) {echo "";}else{echo "hidden";} ?>">Logout</a>
                                       
                                    </div>
                                    <div class="user-info user-right">
                                        <a class="logged hidden">Hello, <span class="display-name"></span></a>
                                        <a href="#" onclick="document.getElementById('daftar').style.display='block'" title="Sign up" class="signup <?php if ($_SESSION['uid']) {echo "hidden";}else{echo "";} ?>">SIGN UP</a>
...
<a href="termurah.php" class="<?php $a=$_SERVER['SCRIPT_NAME']; $b=explode("/",$a); if($b['3']=="termurah.php"){echo"active";}?>" style="margin:0 5%;" id="menuitems" class="active" href="kategori.php" >Termurah</a>
<a href="terlaris.php"  class="<?php $a=$_SERVER['SCRIPT_NAME']; $b=explode("/",$a); if($b['3']=="terlaris.php"){echo"active";}?>" style="margin:0 5%;" id="menuitems" class="" href="../index.html" >Terlaris</a>
 <a href="nonlemak.php" class="<?php $a=$_SERVER['SCRIPT_NAME']; $b=explode("/",$a); if($b['3']=="nonlemak.php"){echo"active";}?>" style="margin:0 5%;" id="menuitems" class="" href="../index.html" >Non Lemak</a>
<a href="terpopuler.php" class="<?php $a=$_SERVER['SCRIPT_NAME']; $b=explode("/",$a); if($b['3']=="terpopuler.php"){echo"active";}?>" style="margin:0 5%;" id="menuitems" class="" href="../index.html" >Terpopuler</a>
                    
                    
                    
                    </div>
                                 </div>
                        <label class="mobi-secondarymenu" for="menuitems">
