      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tables</a></li>
         <li><a href="./dashboard.php?halaman=paketbuffet">Paket Buffet</a></li>
           <li><a href="#">Ubah Paket Buffet</a></li>
      </ol>
    </section>
...
<form method="post" enctype="multipart/form-data">
  ...
  <img src="../imgevent/<?php echo $paketbuffet['gambar'] ?>" width="200">
</div>
  <div class="form-group">
    <label>Foto</label>
   ...
   <div class="form-group">
    ...
    <input hidden="" type="text" class="form-control" name="jenispaket" value="paketbuffet">
  </div>
  <div class="form-group">
    <label>Judul</label>
    <input type="text" class="form-control" name="judul" value="<?php echo $paketbuffet['judul'] ?>">
  </div>
  <div class="form-group">
    <label>Harga</label>
    <input type="text" class="form-control" name="harga" value="<?php echo $paketbuffet['harga'] ?>">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea type="text" class="form-control" name="keterangan"><?php echo $paketbuffet['keterangan']; ?>
    </textarea>
  </div>
...
<?php if (isset($_POST['ubah']))
{
  ...
  if (!empty($tempat))
  {
  $filenamenew = "fotopaketbuffet".$judul.".".$fileactualext;
 ...
 else
{
  ...
  echo "<script>alert('data paketbuffet telah diubah'>;</script>";
