      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tables</a></li>
         <li><a href="./dashboard.php?halaman=paketbuffet">Paket Buffet</a></li>
           <li><a href="./dashboard.php?halaman=tambahpaketbuffet">Tambah Paket Buffet</a></li>
      </ol>
    </section>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input  type="hidden" class="form-control" name="jenispaket" value="paketbuffet">
  </div>
...
<?php if (isset($_POST['save']))
{
  ...
  echo "<meta http-equiv='refresh' content='1;url=dashboard.php?halaman=paketbuffet'>";
