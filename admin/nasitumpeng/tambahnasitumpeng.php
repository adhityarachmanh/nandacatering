      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tables</a></li>
         <li><a href="./dashboard.php?halaman=nasitumpeng">Nasi Tumpeng</a></li>
           <li><a href="./dashboard.php?halaman=tambahnasitumpeng">Tambah Nasi Tumpeng</a></li>
      </ol>
    </section>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input  type="hidden" class="form-control" name="jenispaket" value="nasitumpeng">
  </div>
...
<?php if (isset($_POST['save']))
{
  ...
  echo "<meta http-equiv='refresh' content='1;url=dashboard.php?halaman=nasitumpeng'>";
