      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tables</a></li>
         <li><a href="./dashboard.php?halaman=nasibox">Nasi Box</a></li>
           <li><a href="./dashboard.php?halaman=tambahnasibox">Tambah Nasi Box</a></li>
      </ol>
    </section>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input  type="hidden" class="form-control" name="jenispaket" value="nasibox">
  </div>
  <div class="form-group">
    <label>Harga</label>
...
<?php if (isset($_POST['save']))
{
  ...
  echo "<meta http-equiv='refresh' content='1;url=dashboard.php?halaman=nasibox'>";
