...
<form method="post" enctype="multipart/form-data">
  ...
  <img src="../imgevent/<?php echo $nasibox['gambar'] ?>" width="200">
</div>
  <div class="form-group">
    <label>Foto</label>
  ...
  <div class="form-group">
    <label>Judul</label>
    <input type="text" class="form-control" name="judul" value="<?php echo $nasibox['judul'] ?>">
  </div>
  <div class="form-group">
    <label>Harga</label>
    <input type="text" class="form-control" name="harga" value="<?php echo $nasibox['harga'] ?>">
  </div>
   <div class="form-group">
    
    <input hidden="" type="text" class="form-control" name="jenispaket" value="nasibox">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="keterangan" value="<?php echo $nasibox['keterangan']; ?>" >
...
<?php if (isset($_POST['ubah']))
{
  ...
  if (!empty($tempat))
  {
   ...
   $filenamenew = "fotonasibox".$judul.".".$fileactualext;
 ...
 else
{
  ...
  echo "<script>alert('data nasibox telah diubah'>;</script>";
