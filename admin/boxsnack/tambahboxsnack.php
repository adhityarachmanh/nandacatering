...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tables</a></li>
         <li><a href="./dashboard.php?halaman=boxsnack">Box Snack</a></li>
           <li><a href="./dashboard.php?halaman=tambahboxsnack">Tambah Box Snack</a></li>
      </ol>
    </section>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input  type="hidden" class="form-control" name="jenispaket" value="boxsnack">
  </div>
...
<?php if (isset($_POST['save']))
{
  ...
  $filenamenew = "fotoboxsnack".$judul.".".$fileactualext;
	...
	echo "<meta http-equiv='refresh' content='1;url=dashboard.php?halaman=boxsnack'>";
