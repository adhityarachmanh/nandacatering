...
<form method="post" enctype="multipart/form-data">
  ...
  <img src="../imgevent/<?php echo $boxsnack['gambar'] ?>" width="200">
</div>
  <div class="form-group">
    <label>Foto</label>
  ...
  <div class="form-group">
    <label>Judul</label>
    <input type="text" class="form-control" name="judul" value="<?php echo $boxsnack['judul'] ?>">
  </div>
  <div class="form-group">
    <label>Harga</label>
    <input type="text" class="form-control" name="harga" value="<?php echo $boxsnack['harga'] ?>">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea type="text" class="form-control" name="keterangan"><?php echo $boxsnack['keterangan']; ?>
    </textarea>
  </div>
