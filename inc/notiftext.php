...
$notif="http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    ...
    elseif (strpos($notif,"status=usernametidakada")== true) {
    ...
    }elseif(strpos($notif,"status=passtidaksama")== true) {
        echo "Username Tidak Terdaftar";
    ...
    }elseif (strpos($notif,"register=kosong")== true) {
        echo "Isi Data Anda Untuk Mendaftar Akun";
        ...
        echo "Rating Berhasil Di Update";
    }
?>